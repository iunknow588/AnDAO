...
export const WALLET_USER_USE_CASES: WalletUserUseCase[] = [
  {
    ...
    title: '路径A：极简体验（新手）',
    summary: '无 EOA 也可使用，由赞助商代付 Gas；守护人数量达到3个后可升级到标准用户。',
  ...
  },
  {
    ...
    title: '路径B：标准模式（进阶）',
    summary: '支持 EOA 管理与自付 Gas；当链上原生Gas余额达到阈值（默认10）可升级赞助商。',
  ...
  },
  {
    ...
    title: '路径C：成为赞助商',
    summary: '完成赞助商注册并通过审核后，可为他人代付与审核，并可在绑定链执行合约部署。',
    loginHint: '已有赞助商账户请先登录再进入控制台。',
    registerHint: '新用户注册后进入路径C完成赞助商注册流程。',
    securityReminder: '请妥善保管密码与私钥，不截图、不外传。',
  },
];
